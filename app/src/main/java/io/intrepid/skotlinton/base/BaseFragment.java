...
public abstract class BaseFragment<T extends BaseContract.Presenter> extends Fragment implements BaseContract.View {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        PresenterConfiguration configuration = getSkotlintonApplication().getPresenterConfiguration();
    ...
    protected final SkotlintonApplication getSkotlintonApplication() {
        return (SkotlintonApplication) getActivity().getApplication();
    }
}
